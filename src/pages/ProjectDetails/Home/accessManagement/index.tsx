            ...
            <div className="home_content">
                ...
                <div className="user_info">
                    ...
                    <div className="content">
                        ...
                        <div className="detail"> 在线用户数量: <span>52</span></div>
                        <div className="detail"> 管理员用户数量: <span>52</span></div>
                        <div className="detail"> 职能域用户数量: <span>52</span></div>
                        <div className="detail"> 普通用户数量: <span>52</span></div>
                    </div>
                </div>
            </div>
